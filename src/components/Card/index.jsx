...
import link_black from "@/assets/img/link-black.svg";
import link_white from "@/assets/img/link-white.svg";
const Card = ({ img, title, github, related, web }) => {
  ...
  return (
    <div className="card" id={theme}>
      ...
      <div className="bottom">
        <h3 className="bottom__heading">
          <a href={web} target="_blank">
            {title}
          </a>
        </h3>

        <div className="bottom__techstack">
          <span className="bottom__techstack-title">Tech stack:</span>
          <div className="bottom__techstack-related">
            {related?.map((e, id) => (
              <img src={e} alt={e} key={id} />
            ))}
          </div>

          <div className="bottom__techstack-link" id={theme}>
            <a href={web} target="_blank">
              <img
                src={theme === "light" ? link_black : link_white}
                alt="link"
              />
              Live Preview
            </a>
